...
(deftestfixture segment-term-enum
  ...
  (:testfun test-segment-term-enum-initialize
		...
		(let* ((tis-file (open-input dir "_test.tis"))
		  ...
		  (test segment-term-enum-init-9 (prev ste) (elt terms 0) #'term=)
		  ...
		  (test segment-term-enum-init-13 (prev ste) (elt terms 1) #'term=)
		  ...
		  (test segment-term-enum-init-17 (prev ste) (elt terms 2) #'term=)
